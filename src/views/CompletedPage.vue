<template>
  <ion-page>
    <ion-content class="ion-padding" :fullscreen="true" aria-label="Completed Tasks Page">
      <!-- Header and introductory text -->
      <h1 aria-label="Completed Page Heading">Completed Tasks</h1>
      <p aria-label="Completed Page Description">Here you'll find all your completed tasks.</p>
      <p aria-label="Completed Page Note">The main task of the report is be marked with:
        <span>
      ...
      <ion-accordion-group ref="accordionGroup" aria-label="Accordion Group of Completed Reports">
        ...
        <ion-accordion
          ...
          <div class="ion-padding" slot="content" aria-label="Report Content">
            <ion-list aria-label="Report List">
              <ion-item-group
                ...
                <ion-item-divider aria-label="Report Item Divider">
            ...
            <ion-button class="save" shape="round" @click="saveReport(report.id)" expand="block" aria-label="Save Report Button">
              <ion-icon slot="start" :icon="arrowDownCircleOutline" aria-hidden="true"></ion-icon>
