<template>
  <ion-page>
    <ion-content
      ...
      <h1
        aria-label="Open Tasks Page Heading">
        Scheduled Tasks
      </h1>
      <p
        aria-label="Open Tasks Page Description">
        Here you'll find all your scheduled tasks.
      </p>
      <p
        aria-label="Open Tasks Page Note">
        The main task of the report will be marked with:
        <span>
          <ion-badge
            id="example-badge"
            color="warning"
      ...
      <ion-accordion-group
        aria-label="Accordion Group of Open Reports">
        ...
        <ion-accordion
          ...
          <div
            ...
            <ion-button
              ...
              expand="block"
              aria-label="Complete Report Button">
              <ion-icon
                slot="start"
...
<script setup>
  ...
  // Computed property to access openReports from store
